...
const SoftTyres = {
    ...
    name: 'Soft Tyres',
    description: 'The red-banded soft compounds are for dry conditions, and maximize speed at the expense of durability.',
};
const MediumTyres = {
    ...
    name: 'Medium Tyres',
    description: 'The harder yellow-banded medium compounds are for dry conditions, these tyres present a balanced choice between speed and durability.',
};
const HardTyres = {
    subType: 'Hard Tyres',
    subTypeId: '3',
    ...
    name: 'Hard Tyres',
    description: 'The hardest tyre is the white-banded medium compound, preferred for its durability on demanding tracks, but slower to get going.',
};
const IntermediateTyres = {
    ...
    description: 'The green-banded intermediate tyres are for wet conditions, able to provide grip in light rain thanks to a tread pattern.',
};
const WetTyres = {
    subType: 'Wet Tyres',
    subTypeId: '5',
