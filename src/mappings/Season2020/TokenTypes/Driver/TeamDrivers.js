...
const LandoNorris = {
    ...
    extendedMeta: {
        name: 'Lando Norris',
        description:
            'Lando Norris is a British driver competing for McLaren. A promising newcomer, 2019 will be his first season with Formula 1.',
    },
};
...
const KevinMagnussen = {
    ...
    extendedMeta: {
        ...
        description:
            'Kevin Magnussen is a Danish driver competing for Haas. He is the first Dane to achieve a podium finish in Formula 1.',
    },
};
...
const NicoHulkenberg = {
    ...
    extendedMeta: {
        ...
        description:
            'Nico Hulkenberg is a German driver competing for Renault. A strategic midfield driver, he earns solid points.',
    },
};
const MaxVerstappen = {
    driverId: '33',
    ...
    extendedMeta: {
        name: 'Max Verstappen',
        description:
            'Max Verstappen is a Dutch driver competing for Red Bull Racing. He is the youngest driver to earn points in F1 history.',
    },
};
const LewisHamilton = {
    driverId: '44',
...
const ValtteriBottas = {
    ...
    extendedMeta: {
        ...
        description:
            'Valtteri Bottas is a Finnish driver competing for Mercedes. During his 3 years with Mercedes he has taken home 26 podiums.',
    },
};
const RobertKubica = {
    driverId: '88',
    ...
    extendedMeta: {
        name: 'Robert Kubica',
        description:
            'Robert Kubica is a Polish driver competing for Williams. In 2019 he returns to Formula 1 after an 8 year absence.',
    },
};
const AntonioGiovinazzi = {
    ...
    extendedMeta: {
        ...
        description:
            'Antonio Giovinazzi is an Italian driver competing for Alfa Romeo Racing. 2019 will be his first full season in a Formula 1 seat.',
    },
};
