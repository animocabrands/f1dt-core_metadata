...
const SebastianVettel = {
    ...
    description: 'Sebastian Vettel is a German driver competing in his 5th season for Ferrari. He won four FIA Formula 1 Drivers World Championships between 2010 and 2014.'
};
const KimiRaikkonen = {
    driverId: '7',
    name: 'Kimi Räikkönen',
...
const AlexanderAlbon = {
    ...
    description: 'Alexander Albon is a British-Thai driver competing for Red Bull Racing. A confident overtaker, 2019 marks his first season in Formula 1.'
};
const DaniilKvyat = {
    driverId: '26',
    name: 'Daniil Kvyat',
