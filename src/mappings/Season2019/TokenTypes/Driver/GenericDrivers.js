...
const CloverDriver = {
    ...
    description: 'Regardless of the season, weather or car, the Clover driver sets the benchmark for speed. Tearing through the warm-up sessions, and constantly setting record splits.'
};
const RayDriver = {
    name: 'Ray Driver',
    model: Models.RayModel.model,
    description: "The Ray driver is a qualifying specialist. Always assured to deliver quick times and high grid placement, especially when the car is set-up with hot tyres and a lap's worth of fuel."
};
const PlumeDriver = {
    name: 'Plume Driver',
