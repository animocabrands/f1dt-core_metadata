...
const The111 = {
    ...
    description: 'The 1-1-1 is the very first official Formula 1® non-fungible token. This is the first car to be released for F1® Delta Time, and we made this a hyper-limited edition: there is just one single 1-1-1, and there will never be another. It’s truly a one-of-a-kind digital collectible.',
...
const MonacoEdition2019 = {
    ...
    description: 'The Monaco Edition 2019 car is a one of a kind asset, making it unique and exclusive. It is an extreme performance digital asset due to its blisteringly fast pace on the track. The car benefits from a hometown advantage - receiving a boost when racing at the Circuit de Monaco.',
...
const ChinaEdition2019AzureDragon = {
    ...
    youtube_url: 'https://www.youtube.com/watch?v=gXdJdxL91Fs'
};
