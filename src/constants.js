...
const BitsLayout = [
    ...
    { name: "type", bits: 8 },             // 240
    { name: "subType", bits: 8 },          // 232
    { name: "season", bits: 8 },           // 224
    //           OTHER ATTRIBUTES          //
    { name: "padding2", bits: 24 },        // 200
    { name: "model", bits: 8 },            // 192
    { name: "team", bits: 8 },             // 184
    { name: "rarity", bits: 8 },           // 176
    { name: "track", bits: 8 },            // 168
    { name: "label", bits: 16 },           // 152
    { name: "driverNumber", bits: 16 },    // 136
